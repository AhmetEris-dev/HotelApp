...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(OdaKiralamaException.class)// istisnayı yakalayan kısım
	@ResponseBody
	public ResponseEntity<ErrorMessage> OdaKiralamaException(OdaKiralamaException exception){
